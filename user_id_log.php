...
if (isset($_GET['user_id'])) {
    ...
    if (!$user) {
        ...
        // Retrieve user login activity from the user_log table
        $activity_query = "SELECT * FROM user_log WHERE user_id = $user_id ORDER BY login_time DESC";
...
<head>
    ...
    <style>
        /* Styles for the navigation bar and user login activity page */
        /* ... CSS styles ... */
...
<body>
    ...
    <div class="container">
        <h3>User Login Activity - <?php echo $user['username']; ?></h3>
                ...
                <tbody>
                    <?php foreach ($activities as $activity) { ?>
                        <tr>
                            ...
                            <td><?php echo $activity['logout_time']; ?></td>
