...
if (isset($_GET['filter_date'])) {
    ...
    $query = "SELECT searches, COUNT(*) AS search_count FROM user_activity WHERE activity_date = '$filter_date' GROUP BY searches";
} else {
    // Retrieve all user search data
    $query = "SELECT searches, COUNT(*) AS search_count FROM user_activity GROUP BY searches";
}
...
<html>
<head>
    <title>User Search Report</title>
        ...
        $(document).ready(function () {
            ...
            $("#datepicker").datepicker({
                ...
                onSelect: function(dateText) {
                    window.location.href = "admin_user_search_report.php?filter_date=" + dateText;
                }
            });
            ...
            var searchChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($searches); ?>,
                    datasets: [{
